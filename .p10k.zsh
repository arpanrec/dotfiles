# Generated by Powerlevel10k configuration wizard on 2022-01-18 at 11:02 IST.
...
# 24h time, round separators, slanted heads, slanted tails, 2 lines, disconnected,
# full frame, sparse, many icons, fluent, transient_prompt, instant_prompt=verbose.
