...
# Ask for the user to enter the bundle file

read -p "Enter the path to the VMware Workstation bundle file: " vmware_bundle_file

tmp_vmware_dir=/tmp/vmware_install_bastille

mkdir /etc/init.d/ $tmp_vmware_dir -p

cp "${vmware_bundle_file}" $tmp_vmware_dir/vmware.bundle
