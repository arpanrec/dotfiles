...
INIT_STORAGE_KES_VERSION="${INIT_STORAGE_KES_VERSION:-"2024-01-11T13-09-29Z"}"
...
INIT_STORAGE_MINIO_VERSION="${INIT_STORAGE_MINIO_VERSION:-"RELEASE.2024-02-17T01-15-57Z"}"
