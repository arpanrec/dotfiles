...
* Static assets are present in [assets branch](https://github.com/arpanrec/dotfiles/tree/assets),
...
* `NEBULA_VERSION`: Version of the nebula playbook to be used. Default `1.14.64`.
