...
- [Wallpaper Resizer and Luminance Detector](./wallpaper_resizer_luminance.py): Resizes wallpapers to fit the screen resolution and places them in the correct directory based on luminance.
